...
import com.gwtao.ui.model.client.fields.IDoubleFieldInfo;
...
public abstract class DoubleFieldInfo<M> implements IDoubleFieldInfo<M> {
  public static final IValueFormat<Double> FORMAT = new IValueFormat<Double>() {

    public Double parse(String text) throws ValueParseException {
      try {
  ...
  public IDoubleFieldInfo<M> setRange(Double minValue, Double maxValue) {
  ...
  public IDoubleFieldInfo<M> setEmptyText(String emptyText) {
  ...
  public void validate(Double val) throws ValidateException {
    if (val != null) {
  ...
  public IValueFormat<Double> getValueFormat() {
    return FORMAT;
  }
}
