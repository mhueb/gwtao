...
@WidgetType(PasswordTextBox.class)
public abstract class PasswordTextBoxAdapter<M, T extends String, F extends PasswordTextBox> extends AbstractFieldAdapter<M, String, F> {
