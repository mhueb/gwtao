 ...
 * the License.
 */
package com.gwtao.webapp.generator;
...
import com.gwtao.webapp.client.IPage;
import com.gwtao.webapp.client.PageFactories;
import com.gwtao.webapp.client.PageFactory;
import com.gwtao.webapp.client.PageFactoryRegistry;
import com.gwtao.webapp.client.Pages;
...
public class PageFactoryGenerator extends Generator {
  ...
  private void generateInjector(GeneratorContext context, PrintWriter printWriter, TreeLogger logger, JClassType classType, String packageName, String simpleName) throws NotFoundException {
    ...
    for (PageFactory entry : entries.value()) {
      ...
      src.println("      public IPage create() { return GWT.create( %s.class ); }", entry.page().getName());
      src.println("    } );");
    }
    src.println("  }");
